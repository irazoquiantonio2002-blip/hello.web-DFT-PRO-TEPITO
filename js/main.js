...
(function () {
  ...
  if (marqueeInner) {
    const items = [
      'DTF Textil', 'Colores Vivos', 'Gran Resistencia',
      'Playeras Personalizadas', 'Precios de Mayoreo', 'Formato 58cm x 1m',
      'Envío Gratis desde 20m', 'Entrega el Mismo Día',
      'Calidad Garantizada', 'Atención Personalizada'
    ];
  ...
  function drawFrameWithCursor() {
    ...
    if (glowX > 0) {
      ...
      cg.addColorStop(0,   'rgba(255,45,149,0.12)');
      cg.addColorStop(0.4, 'rgba(255,45,149,0.045)');
